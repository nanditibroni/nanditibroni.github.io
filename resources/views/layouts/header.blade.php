<header id="header">
    <div class="d-flex flex-column">
      <div class="profile">
        <img src="assets/img/img-profile.png" alt="" class="img-fluid rounded-circle" />
        <h1 class="text-light"><a href="index.html">Nandi Tibroni Assopi</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="https://www.instagram.com/tibroni_assopi/" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://www.linkedin.com/in/tibroninandi/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
